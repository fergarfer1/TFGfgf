...
for n=1:907
    ...
    ruta = ['C:\Users\ferga\Documents\MATLAB\TFG\1_mod\' num2str(aux) '.png'];
    if isfile(ruta)
        % Convert image to BMW
        K = imresize(imread(strcat('C:\Users\ferga\Documents\MATLAB\TFG\1_mod\',archivo)),[100 100]);
        img0=rgb2gray(K);
