...
for n=1:2069
    ...
    ruta = ['C:\Users\ferga\Documents\MATLAB\TFG\5_mod\' num2str(aux) '.png'];
    if isfile(ruta)
        % Convert image to BMW
        K = imresize(imread(strcat('C:\Users\ferga\Documents\MATLAB\TFG\5_mod\',archivo)),[100 150]);
        img0=rgb2gray(K);
